...
- answered public forum and Discord questions about “is whirled.com dead?” for a decade
...
Public exhibit page (not a grant, not a claim they fund us): https://virtualworlds.museum/exhibits/whirled
...
- **Do not publish private mail.** Public pages cite public URLs and published writing only.
- **whirled.club is not us.** Link it. Do not impersonate it. Do not tell their players we are the official sequel.
- **Public preservation sites** we may link: MADE (https://www.themade.org), Virtual Worlds Museum, NeoHabitat (https://neohabitat.org). Linking a public site is not a claim they endorsed this repo.
