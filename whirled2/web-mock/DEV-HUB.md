...
Bump `LOGO_V` in `app.js` + matching `?v=` on `index.html`. See [STATUS.md](./STATUS.md). **This build:** `?v=20260906bd` — Hybrid Flash loft + pale-blue room chrome (see `QA-FLASH.md`).
...
### Classic Flash module (?v=20260906bd)
