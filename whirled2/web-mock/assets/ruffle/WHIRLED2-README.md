...
- Demo QA SWF: `demo-qa.swf` (paint-only smoke)
- Body demo SWF: `demo-avatar.swf` (AvatarControl mimic for `?flashQa=1` walk QA; mirror of `assets/avatars/flash-qa/demo-avatar.swf`)
